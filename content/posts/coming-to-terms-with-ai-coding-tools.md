...
couldn't be a plain-old _Programmer_. I understand why, I'm paid to build
software, not write code. Software can be sold, code cannot. But, if I'm being
honest, it's the code, not the software, that I love.
...
its bugs. I don't love it, but no one does either. It's just software.

The idea of a tool that promised to handle the code and let me focus on the
software sounded awful. Those beautiful puzzles and algorithms would now be
implementation details handled by the machine. All that would be left for
me is to write specs and check that the implementation is correct. All software,
no code.
...
I started by telling it to do the entirety of the task I was working on at the
time, and I felt smug when I rejected its attempt. Apparently, it wasn't _that_
...
functions myself, and so that's what I did. But when the function was complete
and I was dreading writing a unit test, I remembered that I could tell Cursor
to do it instead. I had to remind it to verify that its tests actually run, but
I could eventually prod it into writing complete and working tests. They were
uninspiring, but sufficient. I was less vibe-coder, and more mule driver.
...
to this endpoint"), and all sorts of related tasks that aren't even programming
...
understand. At least, that's what I tell myself.
